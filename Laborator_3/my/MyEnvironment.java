...
public class MyEnvironment extends AbstractHuntingEnvironment {
    ...
    public static class MyPerceptions implements Perceptions {
         ...
         * Default constructor.
         *
         * @param agentPos        - agents's position.
         * @param obstacles       - visible obstacles.
         * @param nearbyPredators - visible predators.
         * @param nearbyPrey      - visible prey (if the agent is a predator.
         */
         ...
         * @param nearbyPredators - visible predators.
         * @param nearbyPrey      - visible prey (if the agent is a predator.
         * @param messages        - the messages sent to this agent at the previous step.
         */
        public MyPerceptions(GridPosition agentPos, Set<GridPosition> obstacles,
     ...
     * @param w            - map width.
     * @param h            - map height.
     * @param numPrey      - number of initial Prey agents.
     * @param numPredators - number of Predator agents.
     */
    ...
    public void step() {
        ...
        for (WildlifeAgentData predAg : getPredatorAgents()) {
            Set<GridPosition> nearbyObstacles = getNearbyObstacles(predAg.getPosition(), MyTester.PREDATOR_RANGE);
