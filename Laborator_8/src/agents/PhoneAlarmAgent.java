...
public class PhoneAlarmAgent extends Agent {
    ...
    private static final Map<String, Integer> wakeUpModes = Stream.of(new Object[][]{
            {WakeUpPreference.HARD, 0},	// Default value
            {WakeUpPreference.SOFT, 0}, // Phone alarm is not the softest
        ...
        addBehaviour(new ContractNetResponder(this, template) {
            ...
            protected ACLMessage handleCfp(ACLMessage cfp) throws NotUnderstoodException, RefuseException {
                ...
                if (canPerformAction) {
					...
					((PhoneAlarmAgent) myAgent).setWakeUpMode(agentPreference);
            ...
            protected ACLMessage handleAcceptProposal(ACLMessage cfp, ACLMessage propose, ACLMessage accept) throws FailureException {
				...
				String wakeUpMode = ((PhoneAlarmAgent) myAgent).getWakeUpMode();
