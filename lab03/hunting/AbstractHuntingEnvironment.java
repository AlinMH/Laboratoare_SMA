...
public abstract class AbstractHuntingEnvironment extends AbstractGridEnvironment {
    ...
    public static class WildlifeAgentData extends GridAgentData {
         ...
         * @param type            - the agent type: predator or prey
    ...
    /**
     * @param agentData - the data about the agent to add.
     */
     ...
     * @param w         - width
     * @param h         - height
     * @param predators - predator agents to place on the map.
     * @param prey      - prey agents to place on the map.
     ...
     * Remove a prey agent.
     *
     * @param agentData - the agent to remove, as a reference to its corresponding {@link WildlifeAgentData} instance.
     */
     ...
     *
     * @param pos     Position around which to determine the nearby agents
     * @param range   - the range the agent can observe.
     * @param exclude - agent to exclude from the list (for instance, because this is used to generate perceptions for that
     *                agent).
