...
public class Launcher {
	...
	void startCentralElectionAgents() {
		...
		try {
			...
			AID electionMgrAID = new AID(electionManagerName, AID.ISLOCALNAME);
			AgentController voteCollectorAgentCtrl = containerCentralElection.createNewAgent(voteCollectorName, VoteCollectorAgent.class.getName(), new Object[] {electionMgrAID});
